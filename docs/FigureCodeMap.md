...
| Figure 7 | `figures/Figure7/Figure7_reviewed_GRCh.png` A-K composite plus matched scientific source PDF/PNG assets from `panel_7A_day17_tgi_calculation.*` through `panel_7F_pseudotime_state_pathway_activity.*` | `Results/in-vivo/figure7/runs/20260731_figure7_ak_reviewed_figure7/` |
...
`Figure7_generated_GRCh_candidate.png`; it cannot consume the reviewed SI cache
...
canonical output is `figures/Figure7/Figure7_reviewed_GRCh.png`.
