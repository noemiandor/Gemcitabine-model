...
| Figure 7 | `figures/Figure7/Figure7_reviewed_GRCh.png` A-K composite plus matched scientific source PDF/PNG assets from `panel_7A_day17_tgi_calculation.*` through `panel_7F_pseudotime_state_pathway_activity.*` | `Results/in-vivo/figure7/runs/20260801_raw_pearson_v1_figure7/` |
