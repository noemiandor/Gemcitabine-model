...
| Figure 7 | Publication-scale `figures/Figure7/Figure7_reviewed_GRCh.{pdf,png}` A-K composite plus matched scientific source PDF/PNG assets from `panel_7A_day17_tgi_calculation.*` through `panel_7F_pseudotime_state_pathway_activity.*` | `Results/in-vivo/figure7/runs/20260801_figure7_publication_scale_v5_figure7/` |
