...
\text{For cycling cells:} \\
\frac{dG_{1S}}{dt} &= 2 \cdot f_m \cdot k_2 \cdot G_{2M} - f_s \cdot k_1 \cdot G_{1S} - k_d \cdot C_{\text{gem}} \cdot G_{1S}, \\
\frac{dG_{2M}}{dt} &= f_s \cdot k_1 \cdot G_{1S} - f_m \cdot k_2 \cdot G_{2M} - k_d \cdot C_{\text{gem}} \cdot G_{2M} - k_{\text{NP}} \cdot G_{2M}, \\[1em]
\text{For PACCs:} \\
\frac{dN_P}{dt} &= k_{\text{NP}} \cdot G_{2M} - k_{d2} \cdot N_P, \\
\text{For dead cells:} \\
\frac{dA}{dt} &= k_d \cdot C_{\text{gem}} \cdot (G_{1S} + G_{2M}) + k_{d2} \cdot N_P, \\
\text{For gemcitabine decay:} \\
\frac{dC_{\text{gem}}}{dt} &= -k_{\text{decay}} \cdot C_{\text{gem}}.
\end{align*}
...
\begin{tabular}{rl}
  \hline
  \hline
  $C_{gem}$ & Drug concentration \\
  $k_{decay}$ & Drug decay rate\\
  $k_d , k_{d2}$ & apoptosis rates \\
