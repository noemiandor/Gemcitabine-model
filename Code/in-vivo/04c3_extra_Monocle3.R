...
output_root <- get_env_scalar("EXTRA_MONOCLE3_OUTPUT_ROOT", file.path(results_root, "04c3_extra_Monocle3"))
...
if (nrow(monocle3_cells) == 0) stop("No Monocle3 metric rows found.", call. = FALSE)
