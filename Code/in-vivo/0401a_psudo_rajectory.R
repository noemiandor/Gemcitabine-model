...
output_root <- cfg_value(
  ...
  default = file.path(results_root, "0401a_psudo_rajectory")
)
...
summary_lines <- c(
  ...
  "  Active pseudotrajectory groups are aligned to 0401_trajectory.R: All_cells plus CellLine/Tumor ploidy_all, 2N, and 4N.",
  "",
